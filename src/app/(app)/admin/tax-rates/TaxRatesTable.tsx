...
// fetch — the page still does one server-side hasuraQuery and passes the
// full list down as a prop.
export default function TaxRatesTable({ taxRates }: { taxRates: TaxRate[] }) {
  ...
  return (
    <>
      <SearchInput value={search} onChange={setSearch} placeholder="Search by name or applies-to…" />
      ...
      <div className="rounded-xl border bg-white overflow-hidden">
        {taxRates.length === 0 ? (
          ...
          <div className="p-12 text-center"><p className="text-gray-500">No tax rates match your search.</p></div>
        ) : (
